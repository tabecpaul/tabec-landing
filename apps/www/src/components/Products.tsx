...
const items = [
  { icon: <WoodCrossIcon />, title: "나무 십자가", text: "원목·티크 등 다양한 목재로 제작하는 클래식 십자가" },
  { icon: <ResinCrossIcon />, title: "레진 십자가", text: "레진·아크릴 소재로 정교하게 캐스팅하는 십자가" },
  { icon: <FigurineChurchIcon />, title: "조각상 / 예배당", text: "기도하는 인물 조각상, 교회 건물을 본뜬 미니어처 예배당" },
  { icon: <CommunionIcon />, title: "성찬 컵 / 전병", text: "성찬컵·성찬떡·성찬전병 등 성찬식용 소모품·용기 제작" },
